            ...
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="{{ asset('assets/images/menu-2.jpg') }}" class="image-popup"><img
                            src="{{ asset($product->cover) }}" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    ...
                    <p><a href="{{ route('cart.add', $product->id) }}" class="btn btn-black py-3 px-5">Add to Cart</a></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                @foreach($products as $product)
                    <div class="col-sm col-md-6 col-lg ftco-animate">
                        <div class="product">
                            <a href="/show/{{ $product->id }}" class="img-prod"><img class="img-fluid" src="{{ asset($product->cover) }}"
