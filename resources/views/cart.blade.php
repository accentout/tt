                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($products as $product)
                                    <tr class="text-center">
                                        <td class="product-remove"><a href="{{route('cart.delete', $product->id)}}"><span class="ion-ios-close"></span></a>
                                        </td>

                                        <td class="image-prod">
                                            <a href="{{ route('show', $product->id) }}" class="img-prod"><img class="img-fluid" src="{{ asset($product->cover) }}"
